...
STREAMX_ENVIRONMENT_SIZE="${STREAMX_ENVIRONMENT_SIZE:-small}"
export QUARKUS_PROFILE=cloud,${STREAMX_ENVIRONMENT_SIZE} && streamx --accept-license deploy -f "$SETUP_ENV_SCRIPT_DIR/../../mesh/mesh.yaml"
popd || exit
